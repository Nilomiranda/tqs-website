...
export default class IndexPage extends React.Component {
  ...
  async submitInfo (event) {
    ...
    return await fetch(url, {
      ...
      .then(data => {
        this.setState({ mailReturn: data.message })
      })
  }
      ...
      <Layout>
        ...
        <div className="about-container">
          ...
          <div id="about-us" className="about-content">
            <h2>About us</h2>
            <p>
              We are an english school who wants to help you reach the next
              level in your business and profession.
            </p>
            <p>
              We understand that english is one of the most spoken languages
              around the world. Dominating it will enable you to reach new
              heights to offer your services world wide or work for anyone
              around the world.
            </p>
          </div>
        </div>
        <div className="section-container worked-container">
          ...
          <div className="companies-container">
            <img
              src={arcadis}
              data-company="arcadis"
              alt="Arcadis company logo"
            />
            <img src={usp} data-company="usp" alt="USP company logo" />
            <img
              src={safra}
              data-company="safra"
              alt="Safra bank company logo"
            />
          </div>
        </div>
          ...
          <div className="section-container team-members">
            ...
            <div className="member">
              ...
              <div className="member-description">
                ...
                <p>
                  Native English teacher from Liverpool, England. David has been
                  teaching for over 5 years and he’ll always make sure you’ll
                  have fun and learn a lot during the classes.
                </p>
              </div>
            </div>
            <div className="member member-right">
              ...
              <div className="member-description">
                ...
                <p>
                  David’s wife and works together with him related to all
            ...
            <div className="member">
              ...
              <div class="member-description">
                <h3>Breaden Ross</h3>
                <p>
                  Native English teacher from Vancouver, Canada. Working
                  together with David to provide the best teachings to the
                  students.
                </p>
              </div>
            </div>
        ...
        <div className="section-container testimonials-container">
          ...
          <div className="testimonials">
            <div className="testimonial">
              <p>
                “David is an excellent teacher, his way of teaching, always
                focused on his students, is very efficient and productive… I
                always thought learning English was boring, not this time. David
                will teach you with a lot of laughs lol”
              </p>
              <p>Rodrigo Santini</p>
            </div>
            <div className="testimonial">
              <p>
                “The professor of The Queen’s Speech is very dynamic and has an
                excelente method of learning. I have been learning not only with
                books and grammar but also incorporates things within the
                environment that they teach. What makes it most convenient is
                that the company is able to fit round my busy schedule and is
                also able to teach at my place of work.”
              </p>
              <p>Carolina Bernardo</p>
            </div>
            <div className="testimonial">
              <p>
                “I have been studying with David for more than 2 years. I just
                have good things to say about him. He´s very responsible, his
                classes are innovative and very joyful! With him, it´s 100%
                British English, which I prefer and like very much!!. My level
                has improved a lot and now studying English is a hobby! I really
                recommend the Queen´s Speech for those who want a new experience
                learning English.”
              </p>
        ...
        <div className="services-container">
          <div className="tri-right" />
          <div className="services-content section-container" id="services">
            <h2>Services</h2>
        ...
        <div className="section-container email-container">
          <div className="signup-container">
            ...
            <form onSubmit={this.submitInfo}>
              ...
              <span className="submit-return">{this.state.mailReturn}</span>
            </form>
          </div>
        </div>
